...
$(document).ready(function() {
    ...
    $('#switch-to-top-btn').click(function(){
        $("#app-page #main-panel").load(window.app.getRootUrl() + "components/topPhotos/topPhotos.html")
    });
    /* Attach click event to button 'switch-to-request-btn' */
    $('#switch-to-request-btn').click(function(){
        $("#app-page #main-panel").load(window.app.getRootUrl() + "components/requestPhoto/requestPhoto.html")
    });
    /* Attach click event to button 'switch-to-post-btn' */
    $('#switch-to-post-btn').click(function(){
        $("#app-page #main-panel").load(window.app.getRootUrl() + "components/postPhoto/postPhoto.html")
    });
    /* Attach click event to button 'switch-to-account-btn' */
    $('#switch-to-account-btn').click(function(){
        $("#app-page #main-panel").load(window.app.getRootUrl() + "components/userAccount/userAccount.html")
    });
